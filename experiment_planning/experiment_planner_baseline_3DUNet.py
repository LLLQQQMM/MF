...
class ExperimentPlanner(object):
    ...
    def get_properties_for_stage(self, current_spacing, original_spacing, original_shape, num_cases,
        ...
        #将它修剪到数据集的中值形状，因为比中值更大的补丁没有多大意义
    ...
    def plan_experiment(self):
        ...
        only_keep_largest_connected_component, min_size_per_class, min_region_size_per_class = OrderedDict([((1, 2), False), ((2,), False), ((1,), False)]), None, OrderedDict([(1, 0.43368587562900107), (2, 201.21860833840117)])
